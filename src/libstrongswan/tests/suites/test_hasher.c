...
static struct {
	...
	{ SIGN_RSA_EMSA_PKCS1_PSS,	  HASH_UNKNOWN    },
...
static struct {
	...
	{ SIGN_RSA_EMSA_PKCS1_PSS, .p.pss = { .hash = HASH_SHA256 }, HASH_SHA256 },
	{ SIGN_RSA_EMSA_PKCS1_PSS, .p.pss = { .hash = HASH_SHA512 }, HASH_SHA512 },
